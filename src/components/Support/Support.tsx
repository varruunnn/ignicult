...
const Support = () => {
  ...
  return (
    <section>
      <section className="py-[100px]  h-[100vh] lg:hidden text-white max-w-md overflow-y-auto mx-auto relative px-6"
      >
        <motion.h2
      ...
      <section className="py-[100px] max-[1023px]:hidden h-[100vh]  text-white max-w-md mx-auto relative px-6"
      >
        <motion.h2
          variants={headerVariants}
          initial="hidden"
